...
def app():
    ...
    st.write('### Context')
    st.write('It is important to detect humans on footage of CCTV, so, let us use this dataset to train a neural network to do it')
    st.write('### Content')
    st.write('Dataset contains CCTV footage images(as indoor as outdoor), a half of them w humans and a half of them is w/o humans. ')
